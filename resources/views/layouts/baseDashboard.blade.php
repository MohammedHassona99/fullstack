...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('show_news') }}">
                    All News
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('show_category') }}">
                    Show The Categories
                </a>
            </li>
            <!-- Nav Item - Utilities Collapse Menu -->
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('images_library') }}">
                    Show The Images
                </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('show_course') }}">
                    Show Courses
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('add_course') }}">
                    Add Course
                </a>
            </li>
            <li class="nav-item">
